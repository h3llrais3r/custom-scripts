...
# It moves an episode and its subtitle from Auto-Subliminal to the SickRage post processing folder.
# CONFIGURATION: changes the values of AUTOSUBLIMINAL_PATH and SICKRAGE_PATH to your paths.
...
LOG_FILE = os.path.dirname(os.path.realpath(__file__)) + "/autoSubliminalToSickrage.log"
    ...
    try:
        ...
        if subtitles:
            ...
            for subtitle in subtitles:
                shutil.move(subtitle, destination)
                print "Moved additional found subtitle to the Sickrage post processing folder: %s" % subtitle
                logger.info("Moved additional found subtitle to the Sickrage post processing folder: %s" % subtitle)
