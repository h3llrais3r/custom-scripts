    ...
    try:
        ...
        if subtitles:
            ...
            for subtitle in subtitles:
                shutil.move(subtitle, destination)
                print "Moved addtional subtitle to the Sickrage post processing folder: %s" % subtitle
                logger.info("Moved additional subtitle to the Sickrage post processing folder: %s" % subtitle)
